      ...
      'border-white/20' => !$errors->has('label'),
        ...
        <div>
          <label class="flex items-center gap-3">
            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $roomType->is_active) ? 'checked' : '' }} class="w-4 h-4 text-blue-500 border-white/20 rounded focus:ring-blue-500">
