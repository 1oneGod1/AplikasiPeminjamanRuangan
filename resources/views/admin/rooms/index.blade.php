            ...
            <tr class="hover:bg-white/5 transition-colors">
              ...
              <td class="px-4 lg:px-6 py-4">
                <div class="flex items-center justify-center gap-2">
                  <button onclick="openEditRoomModal({{ $room->id }})" class="text-yellow-400 hover:text-yellow-300 font-medium transition-colors">Edit</button>
    ...
    @forelse($rooms as $room)
      <div class="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-4 space-y-3">
        ...
        <div class="flex items-center gap-2 pt-2 border-t border-white/10">
          <button onclick="openEditRoomModal({{ $room->id }})" class="flex-1 text-yellow-400 hover:text-yellow-300 font-medium transition-colors text-center">Edit</button>
          <span class="text-slate-700">·</span>
...
@include('admin.modals.create-room-modal')
@include('admin.modals.edit-room-modal')
@endsection
