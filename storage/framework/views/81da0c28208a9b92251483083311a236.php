			...
			<div class="grid lg:grid-cols-12 gap-8 items-start">
				<div class="lg:col-span-8 space-y-6">
					<div>
						...
						<h1 class="mt-2 text-3xl sm:text-4xl font-semibold">Halo, <?php echo e(auth()->user()->name); ?> 👋</h1>
							...
							<label class="block">
								...
								<select name="type" class="mt-2 w-full rounded-xl border border-white/20 bg-white/10 px-3 py-2 text-white focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/60">
									<?php $__currentLoopData = $roomTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($value); ?>" <?php echo e($filters['type'] === $value ? 'selected' : ''); ?> class="text-slate-900"><?php echo e($label); ?></option>
					...
					<div class="rounded-3xl bg-slate-800/80 border border-white/10 backdrop-blur p-6 space-y-5 shadow-xl">
						...
						<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
							<div class="rounded-2xl bg-yellow-400/90 px-5 py-6 text-slate-900 shadow flex flex-col items-center text-center">
								...
								<p class="mt-3 text-3xl font-bold"><?php echo e($summary['available']); ?></p>
							</div>
							<div class="rounded-2xl bg-yellow-400/90 px-5 py-6 text-slate-900 shadow flex flex-col items-center text-center">
								<p class="text-xs font-semibold uppercase tracking-wide">Terpesan</p>
								<p class="mt-3 text-3xl font-bold"><?php echo e($summary['booked']); ?></p>
							</div>
							<div class="rounded-2xl bg-yellow-400/90 px-5 py-6 text-slate-900 shadow flex flex-col items-center text-center">
								<p class="text-xs font-semibold uppercase tracking-wide">Jumlah Ruangan</p>
								<p class="mt-3 text-3xl font-bold"><?php echo e($summary['total_rooms']); ?></p>
							</div>
							<div class="rounded-2xl bg-yellow-400/90 px-5 py-6 text-slate-900 shadow flex flex-col items-center text-center">
								<p class="text-xs font-semibold uppercase tracking-wide">Pengajuan Saya</p>
								<p class="mt-3 text-3xl font-bold"><?php echo e($summary['my_requests']); ?></p>
							</div>
						</div>
					</div>
				</div>
