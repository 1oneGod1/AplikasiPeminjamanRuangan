...
<?php $__env->startSection('title', 'Jadwal Mendatang - Room Manager'); ?>
        ...
        <section class="rounded-3xl border border-white/5 bg-slate-900/60 p-6 shadow-xl shadow-black/30 space-y-6">
            ...
            <form method="GET" class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex gap-2">
                    ...
                    <?php if(request()->has('room_id') && request('room_id') !== null && request('room_id') !== ''): ?>
                        <a href="<?php echo e(route('room-manager.upcoming-bookings')); ?>" class="inline-flex items-center gap-2 rounded-2xl border border-slate-700/70 bg-slate-900/60 px-5 py-2.5 text-sm font-semibold text-slate-200 transition hover:bg-slate-800">Reset</a>
                    <?php endif; ?>
                </div>
            </form>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-900/50 transition">
                                ...
                                <td class="px-4 py-4">
                                    ...
                                    <div class="text-xs text-slate-400 uppercase tracking-[0.25em]"><?php echo e(str_replace('_', ' ', $booking->room->type)); ?></div>
                                </td>
                                <td class="px-4 py-4">
                                    <?php echo e(\Illuminate\Support\Carbon::parse($booking->booking_date)->translatedFormat('d M Y')); ?>
                                ...
                                <td class="px-4 py-4">
                                    <?php if($booking->purpose): ?>
                                        <button type="button"
                                            ...
                                            data-purpose="<?php echo e(e($booking->purpose)); ?>"
                                            data-purpose-title="Keperluan · <?php echo e($booking->room->name); ?>"
                                ...
                                <td class="px-4 py-4">
                                    <div class="flex flex-wrap items-center gap-2">
                                        <button type="button"
                                            ...
                                            data-action="<?php echo e(route('room-manager.change-request', $booking)); ?>"
                                            data-type="<?php echo e(\App\Models\BookingChangeRequest::TYPE_EDIT); ?>"
                                            data-modal-title="Ajukan Perubahan Jadwal"
                                            data-placeholder="Jelaskan perubahan yang diinginkan"
                                            data-pending="<?php echo e($editPending ? 'true' : 'false'); ?>"
                                            <?php if($editPending): ?> disabled aria-disabled="true" title="Menunggu admin · <?php echo e(\Illuminate\Support\Str::limit($editReason, 80)); ?>" <?php endif; ?>
                                            ...
                                            <span><?php echo e($editPending ? 'Menunggu Admin' : 'Ajukan Edit'); ?></span>
                                        </button>
                                        <button type="button"
                                            data-change-request-trigger
                                            data-action="<?php echo e(route('room-manager.change-request', $booking)); ?>"
                                            data-type="<?php echo e(\App\Models\BookingChangeRequest::TYPE_CANCEL); ?>"
                                            data-modal-title="Ajukan Pembatalan Jadwal"
                                            data-placeholder="Tuliskan alasan pembatalan jadwal"
                                            data-pending="<?php echo e($cancelPending ? 'true' : 'false'); ?>"
                                            <?php if($cancelPending): ?> disabled aria-disabled="true" title="Menunggu admin · <?php echo e(\Illuminate\Support\Str::limit($cancelReason, 80)); ?>" <?php endif; ?>
                                            class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                                'inline-flex items-center gap-2 rounded-xl border px-3 py-1.5 text-xs font-semibold transition',
                                            ...
                                            <span><?php echo e($cancelPending ? 'Menunggu Admin' : 'Ajukan Pembatalan'); ?></span>
                                        </button>
                                    </div>
                                    <?php if($editPending || $cancelPending): ?>
                                        <p class="mt-2 text-xs text-slate-400/80">
                                            <?php if($editPending): ?>
                                                Edit: "<?php echo e(\Illuminate\Support\Str::limit($editReason, 90)); ?>"
                                            <?php endif; ?>
                                            <?php if($editPending && $cancelPending): ?>
                                                <span class="mx-1 text-slate-700">·</span>
                                            <?php endif; ?>
                                            <?php if($cancelPending): ?>
                                                Batal: "<?php echo e(\Illuminate\Support\Str::limit($cancelReason, 90)); ?>"
                                            <?php endif; ?>
                                        </p>
                                    <?php endif; ?>
                                </td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 4\ENG\ALP\Booking-Ruangan\resources\views/room-manager/upcoming-bookings.blade.php ENDPATH**/ ?>