...
<?php $__env->startSection('title', 'Dashboard Pengatur Ruangan'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        <header class="space-y-4">
            ...
            <div class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                ...
                <div class="flex gap-3">
                    <?php if($managedRooms->isNotEmpty()): ?>
                        <a href="<?php echo e(route('room-manager.rooms')); ?>" class="inline-flex items-center gap-2 rounded-2xl border border-slate-700/70 bg-slate-900/60 px-5 py-2.5 text-sm font-semibold text-slate-200 transition hover:bg-slate-800">Daftar Ruangan</a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('room-manager.pending-bookings')); ?>" class="inline-flex items-center gap-2 rounded-2xl bg-yellow-400 px-5 py-2.5 text-sm font-semibold text-slate-950 shadow-lg shadow-yellow-500/20 transition hover:bg-yellow-300">Pengajuan Pending</a>
                </div>
            </div>
        </header>
        ...
        <section class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <article class="rounded-3xl border border-white/10 bg-slate-900/40 p-6 shadow-2xl shadow-black/40 backdrop-blur">
                ...
                <p class="mt-3 text-4xl font-bold text-white"><?php echo e($totalManagedRooms); ?></p>
            ...
            <article class="rounded-3xl border border-white/10 bg-slate-900/40 p-6 shadow-2xl shadow-black/40 backdrop-blur">
                ...
                <p class="mt-3 text-4xl font-bold text-white"><?php echo e($totalPendingBookings); ?></p>
            ...
            <article class="rounded-3xl border border-white/10 bg-slate-900/40 p-6 shadow-2xl shadow-black/40 backdrop-blur">
                ...
                <p class="mt-3 text-4xl font-bold text-white"><?php echo e($totalApprovedBookings); ?></p>
        ...
        <section class="grid gap-6 lg:grid-cols-2">
            <div class="rounded-3xl border border-white/10 bg-slate-900/50 p-6 shadow-inner shadow-black/30">
                <div class="flex items-center justify-between gap-3">
                    ...
                    <a href="<?php echo e(route('room-manager.rooms')); ?>" class="text-xs font-semibold uppercase tracking-[0.28em] text-yellow-400">Lihat Semua</a>
                </div>
                <div class="mt-5 space-y-3">
                    <?php $__empty_1 = true; $__currentLoopData = $managedRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e(route('room-manager.show-room', $room->id)); ?>" class="flex items-center justify-between rounded-2xl border border-slate-800/80 bg-slate-950/50 px-4 py-3 text-sm text-slate-200 transition hover:border-yellow-400/60 hover:text-white">
                            <div>
                                <p class="font-semibold"><?php echo e($room->name); ?></p>
                                <p class="text-xs text-slate-400"><?php echo e(strtoupper(str_replace('_', ' ', $room->type))); ?></p>
                            </div>
                            <div class="text-right text-xs text-slate-400">
                                <span><?php echo e($room->upcoming_bookings_count ?? 0); ?> jadwal aktif</span>
                            </div>
                        </a>
            ...
            <div class="rounded-3xl border border-white/10 bg-slate-900/50 p-6 shadow-inner shadow-black/30">
                <div class="flex items-center justify-between gap-3">
                    ...
                    <a href="<?php echo e(route('room-manager.upcoming-bookings')); ?>" class="text-xs font-semibold uppercase tracking-[0.28em] text-yellow-400">Jadwal Lengkap</a>
                </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $approvedBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="rounded-2xl border border-slate-800/80 bg-slate-950/40 px-4 py-3 text-sm text-slate-200">
                            <div class="flex items-center justify-between">
                                <p class="font-semibold"><?php echo e($booking->room->name); ?></p>
                            ...
                            <div class="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-slate-400">
                                <span><?php echo e(\Illuminate\Support\Carbon::parse($booking->booking_date)->translatedFormat('d M Y')); ?></span>
                                <span><?php echo e($booking->start_time); ?> - <?php echo e($booking->end_time); ?></span>
                                <span>Peminjam: <?php echo e($booking->user->name); ?></span>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="rounded-2xl border border-dashed border-slate-700 px-4 py-8 text-center text-sm text-slate-400">
                ...
                <div class="mt-4"><?php echo e($approvedBookings->links()); ?></div>
            </div>
        </section>
        ...
        <section class="rounded-3xl border border-white/10 bg-slate-900/60 p-6 shadow-inner shadow-black/30">
            <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                ...
                <a href="<?php echo e(route('room-manager.pending-bookings')); ?>" class="text-xs font-semibold uppercase tracking-[0.28em] text-yellow-400">Kelola Lebih Lengkap</a>
            </div>
                    ...
                    <tbody class="divide-y divide-slate-800/60">
                        <?php $__empty_1 = true; $__currentLoopData = $pendingBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-900/50 transition">
                                <td class="px-4 py-3 font-medium text-white"><?php echo e($booking->room->name); ?></td>
                                <td class="px-4 py-3"><?php echo e(\Illuminate\Support\Carbon::parse($booking->booking_date)->translatedFormat('d M Y')); ?></td>
                                <td class="px-4 py-3"><?php echo e($booking->start_time); ?> - <?php echo e($booking->end_time); ?></td>
                                <td class="px-4 py-3"><?php echo e($booking->user->name); ?></td>
                                <td class="px-4 py-3 text-slate-400"><?php echo e($booking->purpose ?? '-'); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
            ...
            <div class="mt-4"><?php echo e($pendingBookings->links()); ?></div>
        </section>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 4\ENG\ALP\Booking-Ruangan\resources\views/room-manager/dashboard.blade.php ENDPATH**/ ?>