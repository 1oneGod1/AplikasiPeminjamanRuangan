...
<div class="max-w-xl mx-auto">
  <div class="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6">
    <form action="<?php echo e(route('admin.room-types.update', $roomType)); ?>" method="POST">
      <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          <label class="flex items-center gap-3">
            <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $roomType->is_active) ? 'checked' : ''); ?> class="w-4 h-4 text-blue-500 border-white/20 rounded focus:ring-blue-500">
