...
<?php $__env->startSection('header', 'Edit Ruangan'); ?>
...
<div class="max-w-4xl mx-auto">
  ...
  <div class="<?php echo e($adminFormCardClass); ?>">
    <form action="<?php echo e(route('admin.rooms.update', $room)); ?>" method="POST" class="space-y-12">
      <?php echo csrf_field(); ?>
      ...
      <div class="space-y-10">
        <div class="space-y-2.5">
          ...
          <h3 class="<?php echo e($adminFormHeaderClass); ?>">Perbarui informasi ruangan secara akurat</h3>
          <p class="<?php echo e($adminFormSubtextClass); ?>">Pastikan data kapasitas, fasilitas, dan status ruangan selalu terbaru agar peminjaman berjalan lancar.</p>
        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <footer class="flex flex-col gap-3 pt-6 sm:flex-row sm:items-center sm:justify-end <?php echo e($adminFormSectionDivider); ?>">
          ...
          <button type="submit" class="<?php echo e($adminPrimaryButtonClass); ?>">Perbarui Ruangan</button>
        </footer>
      </div>
    </form>
  </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 4\ENG\ALP\Booking-Ruangan\resources\views/admin/rooms/edit.blade.php ENDPATH**/ ?>