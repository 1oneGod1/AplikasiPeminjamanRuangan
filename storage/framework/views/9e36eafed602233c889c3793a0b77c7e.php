        ...
        <div class="mx-auto max-w-7xl px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('login')); ?>" class="rounded-xl border border-white/20 bg-white/5 px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-white/10">Masuk</a>
                    <a href="<?php echo e(route('register')); ?>" class="rounded-xl bg-blue-500 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/30 transition hover:bg-blue-600">Daftar</a>
                </div>
            </div>
        </div>
    </header>
