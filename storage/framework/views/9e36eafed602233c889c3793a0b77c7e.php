    ...
    <header class="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-40">
        ...
        <div data-mobile-nav-menu class="sm:hidden hidden border-t border-slate-200 bg-white shadow-lg dark:border-slate-800 dark:bg-slate-900">
            <div class="px-4 py-4 space-y-3 text-sm">
                <a href="<?php echo e(route('login')); ?>" class="flex items-center justify-between rounded-xl border border-slate-200 px-4 py-3 font-semibold text-slate-700 hover:bg-slate-100 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800">
                    <span>Masuk</span>
                </a>
                <a href="<?php echo e(route('register')); ?>" class="flex items-center justify-between rounded-xl bg-blue-600 px-4 py-3 font-semibold text-white hover:bg-blue-700">
                    <span>Daftar</span>
                </a>
