...
<?php $__env->startSection('title', 'Daftar Peminjam V2'); ?>
<?php $__env->startSection('header', 'Manajemen Peminjam V2'); ?>
...
<div class="space-y-4 md:space-y-6">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
      <h3 class="text-xl md:text-2xl font-bold text-white">Manajemen Peminjam V2</h3>
      <p class="mt-1 text-sm text-slate-400">Kelola data peminjam kedua (peminjam_v2) yang terdaftar</p>
    </div>
    <a href="<?php echo e(route('admin.users.create', 'peminjam_v2')); ?>" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-500 text-white rounded-xl font-semibold hover:bg-blue-600 transition-colors shadow-lg shadow-blue-500/30">
  ...
  <div class="rounded-2xl border border-white/10 bg-linear-to-br from-white/10 to-white/5 backdrop-blur-sm p-6">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h4 class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Total Peminjam V2</h4>
  ...
  <div class="rounded-2xl border border-white/10 bg-linear-to-br from-green-500/20 to-green-500/10 backdrop-blur-sm p-6">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h4 class="text-xs font-semibold text-green-300 uppercase tracking-wider">Peminjam V2 Aktif</h4>
  ...
  <div class="bg-linear-to-r from-slate-800 to-slate-900 px-4 md:px-6 py-4">
      <div class="flex items-center gap-3">
        ...
        <h2 class="text-lg font-bold text-white">Semua Peminjam V2</h2>
      </div>
    </div>
          ...
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <tr>
              <td colspan="6" class="px-6 py-12 text-center">
                ...
                <a href="<?php echo e(route('admin.users.create', 'peminjam_v2')); ?>" class="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors">
                  <i class="fas fa-plus"></i>
                  Tambah sekarang
                </a>
              </td>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 4\ENG\ALP\Booking-Ruangan\resources\views/admin/users/peminjam-v2.blade.php ENDPATH**/ ?>